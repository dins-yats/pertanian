    ...
    <div class="row my-4">
       <div class="col-lg-8">
          ...
          <h1 class="mb-3">Detail Pengaduan</h1>
            <div class="mb-3">
          <a href="/dashboard/reportuser" class="btn btn-primary"><span data-feather="arrow-left"></span> Kembali Ke Menu Post</a>
          <a href="/dashboard/reportuser/{{ $Report->slug }}/edit" class="btn btn-warning"><span data-feather="edit"></span> Edit</a>

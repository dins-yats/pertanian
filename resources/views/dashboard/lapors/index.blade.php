    ...
    <table class="table table-striped table-sm">
      ...
      <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="/dashboard/lapors/{{ $lapor->slug }}"
                 class="badge bg-info"> <span data-feather="eye"></span></a>

                <a href="/dashboard/lapors/{{ $lapor->slug }}/edit" class="badge bg-warning"> <span data-feather="edit"></span></a>
                
                <form action="/dashboard/lapors/{{ $lapor->slug }}" method="post" class="d-inline">
                @method('delete')
                @csrf
